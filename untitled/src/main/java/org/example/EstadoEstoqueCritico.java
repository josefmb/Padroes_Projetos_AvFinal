...
public class EstadoEstoqueCritico implements EstadoEstoque {
    EstoqueSingleton estoqueSingleton;

    public EstadoEstoqueCritico(EstoqueSingleton estoqueSingleton) {
    ...
    public void exibirSituacaoEstoque() {
        System.out.println("Situação do Estoque: Crítica");
    }
}
